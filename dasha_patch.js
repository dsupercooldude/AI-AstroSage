...
const antarBlockStr = `{window.getPratyantarDashas && window.getPratyantarDashas(antar.lord, antar.start, antar.end).map((prat, pIdx) => {`;
...
code = code.replace(
  /<div className="pl-4 space-y-1 border-l border-\[\#27272a\] ml-1">([\s\S]*?\{window\.getPratyantarDashas)/g,
